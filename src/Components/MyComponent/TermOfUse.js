...
export default function TermOfUse() {
  return (<>
  <Header/>
  <div style={{width:'100%',display:'flex',justifyContent:'center',background:'#f1f3f6',paddingTop:50}}>

 
    <Grid style={{ padding: 30 ,width:'70%',background:'#fff' }} container>
     
      <Grid item xs={12}>
      <div><p><strong>Vipin Kirana Terms of Use</strong></p>
...
<p><strong>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name </strong>[<strong>www.Vipin Kirana.com</strong>][www.Vipin Kirana.com] <strong>(“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”) </strong></p>
<p>The Platform is owned by Vipin Kirana Internet Private Limited a company incorporated under the Companies Act, 1956 with its registered office at Buildings Alyssa, Begonia &amp; Clover, Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru – 560103, Karnataka, India and its branch offices at 2nd Floor, Block F (Flora), Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru-560103, Karnataka, India and; 447/C, 12th Main, 4th Block, Koramangala, Bengaluru-560034, Karnataka, India (hereinafter referred to as "Vipin Kirana").</p><p>Your use of the Platform and services and tools are governed by the following terms and conditions <strong>("Terms of Use")</strong> as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with Vipin Kirana Internet Private Limited and these terms and conditions including the policies constitute Your binding obligations, with Vipin Kirana.</p>
<p>For the purpose of these Terms of Use, wherever the context so requires <strong>"You"</strong> or <strong>"User"</strong> shall mean any natural or legal person who has agreed to become a buyer on the Platform by providing Registration Data while registering on the Platform as Registered User using the computer systems. Vipin Kirana allows the User to surf the Platform or making purchases without registering on the Platform. The term <strong>"We", "Us", "Our"</strong> shall mean Vipin Kirana Internet Private Limited.</p>
...
<p>As a minor if you wish to transact on the Platform, such transaction on the Platform may be made by your legal guardian or parents. Vipin Kirana reserves the right to terminate your membership and / or refuse to provide you with access to the Platform if it is brought to Vipin Kirana's notice or if it is discovered that You are under the age of 18 years and transacting on the Platform.</p>
...
<p>You agree that Vipin Kirana shall not be liable or responsible for the activities or consequences of use or misuse of any information that occurs under your Account in cases, including, where You have failed to update Your revised mobile phone number and/or e-mail address on the Website Platform.</p>
...
<p>The Platform is a platform that Users utilize to meet and interact with one another for their transactions. Vipin Kirana is not and cannot be a party to or control in any manner any transaction between the Platform's Users.</p>
<p>Henceforward:</p>
<ol>
<li>All commercial/contractual terms are offered by and agreed to between Buyers and Sellers alone. The commercial/contractual terms include without limitation price, shipping costs, payment methods, payment terms, date, period and mode of delivery, warranties related to products and services and after sales services related to products and services. Vipin Kirana does not have any control or does not determine or advise or in any way involve itself in the offering or acceptance of such commercial/contractual terms between the Buyers and Sellers. All discounts, offers (including exchange offers) are by the Seller/Brand and not by Vipin Kirana.</li>
...
<li>Vipin Kirana does not make any representation or Warranty as to specifics (such as quality, value, salability, etc) of the products or services proposed to be sold or offered to be sold or purchased on the Platform. Vipin Kirana does not implicitly or explicitly support or endorse the sale or purchase of any products or services on the Platform. Vipin Kirana accepts no liability for any errors or omissions, whether on behalf of itself or third parties.</li>
<li>Vipin Kirana is not responsible for any non-performance or breach of any contract entered into between Buyers and Sellers. Vipin Kirana cannot and does not guarantee that the concerned Buyers and/or Sellers will perform any transaction concluded on the Platform. Vipin Kirana shall not and is not required to mediate or resolve any dispute or disagreement between Buyers and Sellers.</li>
...
<li>Vipin Kirana does not at any point of time during any transaction between Buyer and Seller on the Platform come into or take possession of any of the products or services offered by Seller nor does it at any point gain title to or have any rights or claims over the products or services offered by Seller to Buyer.</li>
<li>At no time shall Vipin Kirana hold any right, title or interest over the products nor shall Vipin Kirana have any obligations or liabilities in respect of such contract entered into between Buyers and Sellers. Vipin Kirana is not responsible for unsatisfactory or delayed performance of services or damages or delays as a result of products which are out of stock, unavailable or back ordered.</li>
<li>The Platform is only a platform that can be utilized by Users to reach a larger base to buy and sell products or services. Vipin Kirana is only providing a platform for communication and it is agreed that the contract for sale of any of the products or services shall be a strictly bipartite contract between the Seller and the Buyer.</li>
</ol>
<p>At no time shall Vipin Kirana hold any right, title or interest over the products nor shall Vipin Kirana have any obligations or liabilities in respect of such contract.</p>
<p>Vipin Kirana is not responsible for unsatisfactory or delayed performance of services or damages or delays as a result of products which are out of stock, unavailable or back ordered.</p>
...
<ul>
<li>GST invoice will have, inter alia, the following details printed on it:
-GSTIN associated with your registered business, as provided by you</li>
...
<li>Vipin Kirana is not responsible to verify the correctness of the GSTIN and/or entity name provided by You and You shall be entirely responsible to provide the accurate details.</li>
<li>Vipin Kirana and Seller shall not entertain any request for any revision in the GST Invoice. Vipin Kirana and Seller shall not be liable for Your default including for reasons associated with details provided by You.</li>
<li>Vipin Kirana will not be liable in case You are not able to avail input tax credit or if input tax credit is denied to You for any reason whatsoever.</li>
<li>You shall be solely liable for all compliances required under applicable laws.</li>
<li>You agree to indemnify and hold Vipin Kirana and Seller harmless from all losses, claims, costs, expenses, suits, proceedings, or any other liability including any third-party claims (including any penalties imposed by governmental authorities) arising out of or in connection with (1) the GSTIN and/or entity name provided by you or the input tax credit claimed by you or your use or misuse of the GST Invoice and (2) your non-compliance with the applicable laws or (3) your use or misuse of any third-party’s details including GSTIN.</li>
<li>Vipin Kirana has the right to not allow business purchases on the Platform to You if a fraudulent activity is identified.</li>
...
<li><p>You shall independently agree upon the manner and terms and conditions of delivery, payment, insurance etc. with the seller(s) that You transact with.</p>
</li>
</ol>
...
<ol>
<li>You release and indemnify Vipin Kirana and/or any of its officers and representatives from any cost, damage, liability or other consequence of any of the actions of the Users of the Platform and specifically waive any claims that you may have in this behalf under any applicable law. Notwithstanding its reasonable efforts in that behalf, Vipin Kirana cannot take responsibility or control the information provided by other Users which is made available on the Platform. You may find other User's information to be offensive, harmful, inconsistent, inaccurate, or deceptive. Please use caution and practice safe trading when using the Platform.</li>
</ol>
<p>Please note that there could be risks in dealing with underage persons or people acting under false pretence.</p>
<p><strong>Charges</strong></p>
<p>Vipin Kirana may charge a nominal fee for browsing and buying on the Platform. Vipin Kirana reserves the right to change its Fee Policy from time to time. In particular, Vipin Kirana may at its sole discretion introduce new services/fees and modify some or all of the existing services/fees offered on the Platform. In such an event, Vipin Kirana reserves the right to introduce fees for the new services offered or amend/introduce fees for existing/new services, as the case may be. Changes to the Fee Policy shall be posted on the Platform and such changes shall automatically become effective immediately after they are posted on the Platform. Unless otherwise stated, all fees shall be quoted in Indian Rupees. You shall be solely responsible for compliance of all applicable laws including those in India for making payments to Vipin Kirana Internet Private Limited</p>
...
<p>(o) engages in commercial activities and/or sales without Our prior written consent such as contests, sweepstakes, barter, advertising and pyramid schemes, or the buying or selling of "virtual" products related to the Platform. Throughout this Terms of Use, Vipin Kirana's prior written consent means a communication coming from Vipin Kirana's Legal Department, specifically in response to Your request, and specifically addressing the activity or conduct for which You seek authorization;</p>
...
<li>You may not use the Platform or any content for any purpose that is unlawful or prohibited by these Terms of Use, or to solicit the performance of any illegal activity or other activity which infringes the rights of Vipin Kirana and / or others.</li>
...
<li>Vipin Kirana shall have all the rights to take necessary action and claim damages that may occur due to your involvement/participation in any way on your own or through group/s of people, intentionally or unintentionally in DoS/DDoS (Distributed Denial of Services).</li>
<li><p>If you choose to browse or transact on the Platform using the voice command-based shopping<br/>feature, you acknowledge that Vipin Kirana and/or its affiliates will collect, store and use your voice inputs on this feature to customize your experience and provide additional functionality as well as to improve Vipin Kirana’s and/or its affiliates’ products and services. Vipin Kirana’s and/or its affiliates’ use of your voice data will be in accordance with the Vipin Kirana Privacy Policy. You accept that your use of this feature is restricted to the territory of the Republic of India. This feature may not be accessible on certain devices and requires an internet connection. Vipin Kirana reserves the right to change, enhance, suspend, or discontinue this feature, or any part of it, at any time without notice to you. Your continued use of this feature constitutes your acceptance of the terms related to this feature.</p>
</li>
<li><p>You acknowledge and agree that the Hindi, Telugu, Tamil, Kannada and Marathi, Bengali, Gujarati , Odia, Malayalam, Punjabi &amp; Assamese translation features are made available on the Platform on a reasonable effort basis for convenience only, without any representation or warranties by Vipin Kirana, express or implied, including the translations being error free, their accuracy, completeness or reliability. Under the translation feature, You will have the option to adding delivery addresses in the language selected by You out of the featured languages. Such delivery addresses shall be transliterated in English language for processing, handling and fulfilling Your orders on the Platform. Vipin Kirana expressly disclaims any liability of any nature whatsoever arising from or related to the said translation/transliteration features on the Platform. Some features and sections on the Platform may not be translated in the language selected by You [Hindi, Telugu, Tamil, Kannada, Marathi, Bengali, Gujarati, Odia, Malayalam, Punjabi &amp; Assamese language, as applicable], and the English version of the same will be the definitive version. In the event of any conflict or inconsistency between the translated terms and the English version available on the Platform, the English version on the Platform shall prevail. This feature may not be accessible on certain devices. Vipin Kirana reserves the right to change, enhance, suspend, or discontinue this feature, or any part of it, at any time without notice to You.</p>
</li>
</ol>
<h2 id="terms-conditions-">Terms &amp; Conditions:</h2>
<ul>
<li>Vipin Kirana Foundation is a Section 8 company registered under the Companies Act 2013.</li>
<li>The amount received as donation will be donated to NGOs and similar charitable organizations working in the selected thematic - areas. You can visit www.Vipin Kiranafoundation.org to know more on this. </li>
...
<li>Vipin Kirana Foundation disclaims any and all liability and assumes no responsibility whatsoever for consequences resulting from any actions or inactions of the NGOs or charitable organizations.</li>
<li>By proceeding to donate the money, you consent and expressly waive any and all claims, rights of action and/or remedies (under law or otherwise) that you may have against any of the Vipin Kirana Group entities arising out of or in connection with the aforesaid transaction.</li>
<li>The donation is being collected on behalf of the Vipin Kirana Foundation and is disbursed to Vipin Kirana Foundation. Vipin Kirana Internet Pvt Ltd disclaims all liabilities and assumes no responsibility from consequences resulting from actions/ inactions of the Vipin Kirana Foundation.</li>
</ul>
<p><strong>Contents Posted on Platform</strong></p>
<p>All text, graphics, user interfaces, visual interfaces, photographs, trademarks, logos, sounds, music and artwork (collectively, "Content"), is a third party user generated content and Vipin Kirana has no control over such third party user generated content as Vipin Kirana is merely an intermediary for the purposes of this Terms of Use.</p>
<p>Except as expressly provided in these Terms of Use, no part of the Platform and no Content may be copied, reproduced, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted or distributed in any way (including "mirroring") to any other computer, server, Platform or other medium for publication or distribution or for any commercial enterprise, without Vipin Kirana's express prior written consent.</p>
...
<p>Vipin Kirana will not be liable to You in any way or in relation to the Contents of, or use of, or otherwise in connection with, the Platform. Vipin Kirana does not warrant that this site; information, Content, materials, product (including software) or services included on or otherwise made available to You through the Platform; their servers; or electronic communication sent from Us are free of viruses or other harmful components.</p>
...
<p>Further:</p>
<ol>
<li>Transactions, Transaction Price and all commercial terms such as Delivery, Dispatch of products and/or services are as per principal to principal bipartite contractual obligations between Buyer and Seller and payment facility is merely used by the Buyer and Seller to facilitate the completion of the Transaction. Use of the payment facility shall not render Vipin Kirana liable or responsible for the non-delivery, non-receipt, non-payment, damage, breach of representations and warranties, non-provision of after sales or warranty services or fraud as regards the products and /or services listed on Vipin Kirana's Platform.</li>
<li>You have specifically authorized Vipin Kirana or its service providers to collect, process, facilitate and remit payments and / or the Transaction Price electronically or through Cash on Delivery to and from other Users in respect of transactions through Payment Facility. Your relationship with Vipin Kirana is on a principal to principal basis and by accepting these Terms of Use you agree that Vipin Kirana is an independent contractor for all purposes, and does not have control of or liability for the products or services that are listed on Vipin Kirana's Platform that are paid for by using the Payment Facility. Vipin Kirana does not guarantee the identity of any User nor does it ensure that a Buyer or a Seller will complete a transaction.</li>
<li>You understand, accept and agree that the payment facility provided by Vipin Kirana is neither a banking nor financial service but is merely a facilitator providing an electronic, automated online electronic payment, receiving payment through Cash On Delivery, collection and remittance facility for the Transactions on the Vipin Kirana Platform using the existing authorized banking infrastructure and Credit Card payment gateway networks. Further, by providing Payment Facility, Vipin Kirana is neither acting as trustees nor acting in a fiduciary capacity with respect to the Transaction or the Transaction Price.</li>
</ol>
...
<li>Refund shall be conditional and shall be with recourse available to Vipin Kirana in case of any misuse by Buyer.</li>
...
<li>Vipin Kirana reserves the right to impose limits on the number of Transactions or Transaction Price which Vipin Kirana may receive from on an individual Valid Credit/Debit/ Cash Card / Valid Bank Account/ and such other infrastructure or any other financial instrument directly or indirectly through payment aggregator or through any such facility authorized by Reserve Bank of India to provide enabling support facility for collection and remittance of payment or by an individual Buyer during any time period, and reserves the right to refuse to process Transactions exceeding such limit.</li>
<li>Vipin Kirana reserves the right to refuse to process Transactions by Buyers with a prior history of questionable charges including without limitation breach of any agreements by Buyer with Vipin Kirana or breach/violation of any law or any charges imposed by Issuing Bank or breach of any policy.</li>
<li>Vipin Kirana may do such checks as it deems fit before approving the receipt of/Buyers commitment to pay (for Cash On Delivery transactions) Transaction Price from the Buyer for security or other reasons at the discretion of Vipin Kirana. As a result of such check if Vipin Kirana is not satisfied with the creditability of the Buyer or genuineness of the Transaction or other reasons at its sole discretion, Vipin Kirana shall have the right to reject the receipt of / Buyers commitment to pay Transaction Price. For avoidance of doubt, it is hereby clarified that the ‘Cash on Delivery’ feature for payment, may be disabled for certain account users, at the sole discretion of Vipin Kirana.</li>
<li>Vipin Kirana may delay notifying the payment confirmation i.e. informing Seller to Dispatch, if Vipin Kirana deems suspicious or for Buyers conducting high transaction volumes to ensure safety of the Transaction and Transaction Price. In addition, Vipin Kirana may hold Transaction Price and Vipin Kirana may not inform Seller to Dispatch or remit Transaction Price to law enforcement officials (instead of refunding the same to Buyer) at the request of law enforcement officials or in the event the Buyer is engaged in any form of illegal activity.</li>
<li>The Buyer and Seller acknowledge that Vipin Kirana will not be liable for any damages, interests or claims etc. resulting from not processing a Transaction/Transaction Price or any delay in processing a Transaction/Transaction Price which is beyond control of Vipin Kirana.</li>
</ol>
...
<li>Buyer and Seller shall comply with all the applicable laws (including without limitation Foreign Exchange Management Act, 1999 and the rules made and notifications issued there under and the Exchange Control Manual as may be issued by Reserve Bank of India from time to time, Customs Act, Information and Technology Act, 2000 as amended by the Information Technology (Amendment) Act 2008, Prevention of Money Laundering Act, 2002 and the rules made there under, Foreign Contribution Regulation Act, 1976 and the rules made there under, Income Tax Act, 1961 and the rules made there under, Export Import Policy of government of India) applicable to them respectively for using Payment Facility and Vipin Kirana Platform.</li>
</ol>
...
<p>You agree to indemnity and keep indemnifying Vipin Kirana.com and any future buyer of the device against all or any third party claims, demand, cost, expenses including attorney fees which may be suffered, incurred, undergone and / or sustained by Vipin Kirana.com, its affiliates or any future buyer due to usage of the device by you till date and you undertake to make good the same.</p>
<p>I confirm that all the data in the said device will be erased before handing it over under buy back program. I also confirm that in spite of erasing the data manually/electronically, if any data still accessible due any technical reason, Vipin Kirana.com, Seller or the Manufacturer shall not be responsible for the same and I will not approach Vipin Kirana.com for any retrieval of the data.</p>
...
<p>I agree to indemnity and keep indemnifying the Vipin Kirana.com and any future buyer of the old device against all or any third party claims, demand, cost, expenses including attorney fees which may be suffered, incurred, undergone and / or sustained by Vipin Kirana.com, its affiliates or any future buyer due to usage of the device by me till date and I undertake to make good the same.</p>
<p>I understand once a device is sent by me to Vipin Kirana, in no scenario can this device be returned back to me.</p>
...
<p>All Sales Final; Downloading and Risk of Loss; Availability of MP3 music files: All sales of MP3 music files are final. Returns of MP3 music files are not permissible on Platform. Once You have purchased MP3 music files, Vipin Kirana encourages You to download it promptly. If You are unable to complete a download, please contact <a href="http://www.Vipin Kirana.com/helpcentre">customer service</a> within 6 hours of the payment.</p>
<p>Further Vipin Kirana assumes no liability if your media player does not support the file format made available by the Seller on the Platform or your browser does not support the music download application / software available by the Seller on the Platform, by whatever name called.</p>
...
<table>
 <thead>
  <tr>
   ...
   <th><p>Vipin Kirana Settings</p></th>
  </tr>
 </thead>
 <tbody>
  <tr>
...
<p>Vipin Kirana will allow the user to buy ebook using the following forms of payments.</p>
<p>--&gt; Credit Cards</p>
<p>--&gt; Internet Banking</p>
<p>--&gt; Debit Cards</p>
<p>--&gt; Vipin Kirana Wallet</p>
...
<p>All Sales Final; Downloading and Risk of Loss; Availability of eBooks. All sales of eBooks are final. We do not accept returns of eBooks. Once you have purchased eBooks, we encourage you to download it promptly. If you are unable to complete a download, please contact <a href="http://www.Vipin Kirana.com/helpcentre">customer service</a> within 30 days of the payment. The ebook will be removed from your library and the amount that was charged during the payment will be refunded in the form of store credit. The eBooks will also be replaced in cases of genuine technical errors as mentioned in the replacement policy.</p>
...
<p><strong>Digital Content: Vipin Kirana Ideas</strong></p>
<ol>
<li>These Terms of Service (“Terms”) govern your access to and use of Vipin Kirana Ideas (hereinafter referred to as “Content”). By viewing the Contents you agree to be bound by these Terms. Content posted on the Platform is public and can be viewed by everyone who can see the Page.</li>
<li>Vipin Kirana is hosting the Content generated by third party users (“Content Owner”), within the FK Platform for convenience of Platform Users, and as such, Vipin Kirana has no ownership or control whatsoever in the Contents displayed. The Contents posted by the Content Owners are of personal views wherein Vipin Kirana plays no role in creating/developing the Content. You are responsible for your use of the Platform for viewing the Content.</li>
<li>By hosting the Content on the Platform, Vipin Kirana is neither guaranteeing nor giving any warranty nor making any representation with respect to the Contents. Vipin Kirana is neither endorsing the views, products or the Services, nor is it responsible for quality or features of the content displayed on the Platform. </li>
<li>Any information on the Platform, whether the content or any other information, have not been verified by Vipin Kirana, therefore, Vipin Kirana shall not be responsible for any such content or information. Vipin Kirana will not bear any obligation or liability if You rely on the Contents. </li>
<li>If You choose to view or rely, Vipin Kirana will neither be a party to nor in any manner concerned with the same nor be liable or responsible for any act or omission of the Content Owner. </li>
...
<li>If you see an offensive, abusive, or any unlawful content on the Platform, you can report it to <strong>ideas-support@Vipin Kirana.com</strong></li>
...
<li>Your access to and use of the Services or any Content are at your own risk. You understand and agree that the Services are provided to you on an “AS IS” and “AS AVAILABLE” basis. Vipin Kirana makes no warranty or representation and disclaim all responsibility and liability for: (i) the completeness, accuracy, availability, timeliness, security or reliability of any Content; (ii) any harm to your computer system, loss of data, or other harm that results from your access to or use of any Content; (iii) the deletion of, or the failure to store or to transmit, any Content and other communications maintained by the Services; and (iv) whether the Services will meet your requirements or be available on an uninterrupted, secure, or error-free basis. No advice or information, whether oral or written, obtained through the Content, will create any warranty or representation not expressly made herein.</li>
<li>By using the Services you agree that Vipin Kirana, its parents, affiliates, related companies, officers, directors, employees, agents representatives, partners and licensors, liability is limited to the maximum extent permissible by Law.</li>
<li>We may revise these Terms from time to time.</li>
</ol>
<p><strong>Digital Content: Vipin Kirana Video</strong></p>
<ol>
<li><p>These Terms of Service ("Terms") govern your access to and use of Vipin Kirana Video which is an online over-the-top platform providing users with live and/or on-demand audio and video content of various genres which may be offered by either Vipin Kirana or by third party content providers (all such content, collectively, the "Content").</p>
</li>
<li><p>The Content is being hosted on Vipin Kirana mobile App only ("Platform"), that is owned and operated by Vipin Kirana Internet Private Limited ("Vipin Kirana", "We" or "Our").</p>
</li>
...
<li><p>Use of Vipin Kirana Services is available only to persons who can form a legally binding contract under the Indian Contract Act, 1872.You must be 18 years of age, to avail the Services. Minors may only use the service under the supervision of an adult. Some content offered on the Platform may not be appropriate for viewership by minors. Accordingly, parents and/or the guardians of such children or minors are advised to exercise discretion before allowing their children or minors to access such content on the Platform.</p>
</li>
<li><p>All the Content being offered to the users on the Platform shall be, for the convenience of the users, free of cost, or at such other terms as may be offered by Vipin Kirana or the Content Providers with respect to any Content from time to time, and such other terms shall be communicated to the user at the time of viewing such Content and/or at the time of registering with the Platform. Subject to you accepting these Terms and any other terms as may be communicated to you from time to time, you are given a limited, non-exclusive, non-transferable, non-sub-licensable, revocable permission to view the Platform and avail the Services during the subsistence of your account with Vipin Kirana and no right, title or interest in any Content will be deemed transferred to you.</p>
</li>
<li><p>The Platform is an interactive online platform for the users to view the Content of various genres, which may either be offered by Vipin Kirana or third party content providers. As regards third party audio-video content generated by third parties (such content, the " <strong>Third Party Content</strong>" and such content providers, the " <strong>Content Owners</strong>"), the Platform offers you such Third Party Content by providing hosting services to Content Owners displaying their content and/or by allowing their content to be viewed by you on the Platform by integrating services and application of other audio-video hosting, caching and/or streaming service or infrastructure providers (" <strong>Platform Partners</strong>") who may have content procurement arrangements with the Content Owners The Platform may also provide content which is commissioned by Vipin Kirana and/or is procured by Vipin Kirana either under a license or copyright agreement (such content, " <strong>Vipin Kirana Originals</strong>").</p>
</li>
<li><p>Content will therefore consist of Vipin Kirana Originals or Third Party Content. Content Owners and/or Platform Partners will provide Third Party Content. Specifically, for more information in relation to Third Party Content (including the terms of use relating specifically to Third Partner Content), you may refer to their respective terms and conditions. As such, Vipin Kirana has no ownership or control whatsoever on Third Party Content, whether it is uploaded or streamed by Content Owners or by the Platform Partners. Vipin Kirana plays no role in creating/developing Third Party Content.</p>
</li>
<li><p>As regards all the news content which are also Third Party Content through the Platform Partners, Vipin Kirana's role is strictly limited to providing a uniform resource locator (URL) or a web-address to access and/or share such content on the Internet with the users and all news  content is provided, uploaded, streamed and/or hosted by Content Owners, the Platform Partners and/or their respective agents or service providers. For avoidance of doubt, it is clarified that Vipin Kirana will not be hosting, uploading or streaming any news content on its servers or IT systems. Vipin Kirana will not be exercising any control – physical, editorial or digital - over the news Content being viewed by or provided to the user on the Platform. Vipin Kirana will only be providing the user with an option and/or a medium to access news content through the Platform which, in turn, will provide the Content Providers and/or the Platform Partners an opportunity to disseminate their content on the Platform. The news Content on the Platform is directly uploaded or streamed onto the Platform by Platform Partners who avail of Vipin Kirana's communication platform, without any intervention from Vipin Kirana in the content procurement/uploading/streaming/transmission process. Vipin Kirana's role is that of an 'intermediary' as defined under the Information Technology Act, 2000 and the rules thereunder, with regard to the news  Content. Being an intermediary, Vipin Kirana has no responsibility and/or liability in respect of any news Content on the Platform, including for intellectual property rights infringement, defamation, obscenity or any other violation under applicable law.</p>
</li>
<li><p>Irrespective of whether the Content is a Third Party Content or a Vipin Kirana Original, you, at all times, are responsible for your use of the Platform and for viewing any Content and Vipin Kirana shall have no liability with respect to any loss or damage caused by viewing or relying on the Content. By hosting Vipin Kirana Originals on the Platform and by permitting the hosting, uploading or streaming of Third Party Content on the Platform, Vipin Kirana will neither guaranteeing nor giving any warranty nor making any representation with respect to the Contents. The Content provided on the Platform is for entertainment or information purposes only and Vipin Kirana will neither be endorsing the views, products or the services being depicted or offered as part of the Content, nor will Vipin Kirana be responsible for quality or features of the Content displayed on the Platform. Unless expressly stated otherwise, all characters, themes and events depicted in Vipin Kirana Originals are entirely fictitious and any similarity to actual events or persons, living or dead, is purely coincidental, unintentional or accidental.</p>
</li>
<li><p>Third Party Content will be made available to you through different modes, including via video-on-demand or on a live streaming basis, depending on the nature of the content and at the discretion of the Content Owners and/or Platform Partners. Vipin Kirana Originals will be provided to you through different modes as well as the discretion of Vipin Kirana. You may choose to view any Content at your discretion at a time chosen by you and by accepting these Terms and any other terms relating to such Content.</p>
</li>
<li><p>Please note that the availability of, and your ability to access, the Content or some part of the Services, (a) is subject to applicable law and the contractual arrangements between Vipin Kirana and the Content Owners and/or Platform Partners; and (b) may be dependent upon your geographical location, your Internet/data connectivity or your system capabilities or compatibility with the Platform. Not all Content or Services will be available to all users. On account of the nature of the Internet/data connectivity and system compatibility, the Platform and the Services may also be accessed in various geographical locations. You, therefore, hereby agree and acknowledge that you are accessing the Platform and availing of the Services, at your own risk, choice and initiative, and you agree and undertake to ensure that your use of the Platform and the Services complies with all applicable laws including the local laws in your jurisdiction. Further, you agree and acknowledge that the Services and Content may vary from place to place, time to time and device to device and the quality and the quantity of your access to the Content or the use of the Platform or availing of the Services would be subject to various parameters such as specifications, device, Internet availability and speed, bandwidth, etc.</p>
</li>
<li><p>Any information on the Platform, whether the Content or any other information (other than Vipin Kirana Original), have not been verified by Vipin Kirana, and therefore, Vipin Kirana shall not be responsible for any such Third Party Content or information. Vipin Kirana will not bear any obligation or liability if You rely on the Contents or information and any loss or liability has been incurred by you arising from such Third Party Content or information.</p>
</li>
<li><p>If you choose to view or rely on any Third Party Content or information on the Platform, you will be impliedly accepting the terms of viewing or relying on such Third Party Content or information, as offered by the Content Providers and/or the Platform Partners, and Vipin Kirana will neither be a party to such an arrangement nor will it in any manner be concerned with such an arrangement nor will Vipin Kirana be liable or responsible for any act or omission of the Content Owner and/or the Platform Partners.</p>
</li>
...
<li><p>If you see an offensive, abusive, or any unlawful content on the Platform, you can report it to customer care of Vipin Kirana.</p>
</li>
<li><p>Disclaimer of representations and warranties: Your access to and use of the Services or any Content are at your own risk. You understand and agree that the Services are provided to you on an "AS IS" or "AS AVAILABLE" basis. Vipin Kirana makes no warranty or representation and disclaim all responsibility and liability for: (i) the completeness, accuracy, availability, timeliness, security, security and non-compatibility or reliability of any Content; (ii) any harm to your computer system, loss of data, or other harm that results from your access to or use of any Content; (iii) the deletion of, or the failure to store or to transmit, any Content and other communications maintained by the Services; and (iv) whether the Services will meet your requirements or be available on an uninterrupted, secure, or error-free basis. No advice or information, whether oral or written, obtained through the Content, will create any warranty or representation not expressly made herein or therein.</p>
</li>
<li><p>Limitation of liability: By using the Services, you agree that the liability of Vipin Kirana, its parents, affiliates, related companies, officers, directors, employees, agents, representatives, partners and licensors, shall be limited to the maximum extent permissible by applicable law. In no case shall Vipin Kirana, its directors, officers, employees, affiliates, agents, contractors, principals, or licensors be liable for any direct, indirect, incidental, punitive, special, or consequential damages arising from your use of the Services or any Content or for any other claim related in any way to your access to the Platform and/or use of the Services, including, but not limited to, any errors or omissions in any Content or information on the Platform, or any loss or damage of any kind incurred as a result of the use of the Services and/or reliance on any Content or information on the Platform.</p>
</li>
<li><p>Indemnification: You shall defend, indemnify and hold harmless Vipin Kirana its owners, affiliates, subsidiaries, group companies, partners (as applicable), and their respective officers, directors, agents, and employees (" <strong>Indemnified Parties</strong>"), from and against any claim, demand, damages, obligations, penalty, losses or actions (including reasonable attorneys' fees) made by any third party against the Indemnified Parties or imposed against the Indemnified Parties, due to or arising out of your or your affiliate's or relative's: (a) breach of these Terms, the Privacy Policy and/or any other policies; or (b) violation of any applicable law, rules, regulations; or (c) violation of the rights (including infringement of intellectual property rights) of a third party or Vipin Kirana; or (d) unauthorized, improper, illegal or wrongful use of your Vipin Kirana account (including by you or by any person, including a third party, whether or not authorized or permitted by you). This indemnification obligation will survive the expiry or termination of these Terms and/or your use of the Service.</p>
</li>
<li><p>Force Majeure: You agree that Vipin Kirana shall be under no liability whatsoever to you in the event of non-availability of the Platform and/or any of the Services or any portion thereof, occasioned by an Act of God, war, disease, revolution, riot, civil commotion, strike, lockout, flood, fire, satellite failure, failure of any public utility, man-made disaster, satellite failure or any other cause whatsoever beyond the control of Vipin Kirana (including any event which is caused by the failure or non-performance on the part of the Content Owners or the Platform Partners).</p>
</li>
<li><p>Governing laws: These Terms shall be governed, interpreted, and construed in accordance with the laws of India, without regard to the conflict of law provisions and for resolution of any dispute arising out of your use of the Services or in relation to these Terms. Notwithstanding the foregoing, you agree that (i) Vipin Kirana has the right to bring any proceedings before any court/forum of competent jurisdiction and you irrevocably submit to the jurisdiction of such courts or forum; and (ii) any proceeding brought by you shall be exclusively before the courts in Bengaluru, India.</p>
</li>
...
<li><p>Entire agreement: These Terms, the Privacy Policy and any other terms or policies as may be prescribed by Vipin Kirana from time to time, constitute the entire agreement between you and Vipin Kirana, which will govern your use of or access to the Services and/or the Platform, superseding any prior agreements between you and Vipin Kirana regarding such use or access.</p>
</li>
...
<p>Unless otherwise specified, the material on the Platform is presented solely for the purpose of sale in India. Vipin Kirana make no representation that materials in the Platform are appropriate or available for use in other locations/Countries other than India. Those who choose to access this site from other locations/Countries other than India do so on their own initiative and Vipin Kirana is not responsible for supply of products/refund for the products ordered from other locations/Countries other than India, compliance with local laws, if and to the extent local laws are applicable.</p>
<p><strong>Trademark, Copyright and Restriction</strong></p>
<p>This site is controlled and operated by Vipin Kirana and products are sold by respective Sellers. All material on this site, including images, illustrations, audio clips, and video clips, are protected by copyrights, trademarks, and other intellectual property rights. Material on Platform is solely for Your personal, non-commercial use. You must not copy, reproduce, republish, upload, post, transmit or distribute such material in any way, including by email or other electronic means and whether directly or indirectly and You must not assist any other person to do so. Without the prior written consent of the owner, modification of the materials, use of the materials on any other Platform or networked computer environment or use of the materials for any purpose other than personal, non-commercial use is a violation of the copyrights, trademarks and other proprietary rights, and is prohibited. Any use for which You receive any remuneration, whether in money or otherwise, is a commercial use for the purposes of this clause.</p>
<p>Trademark complaint</p>
<p>Vipin Kirana respects the intellectual property of others. In case You feel that Your Trademark has been infringed, You can write to Vipin Kirana at infringement@Vipin Kirana.com or ss@Vipin Kirana.com.</p>
<p><strong>Product Description</strong></p>
<p>Vipin Kirana we do not warrant that Product description or other content of this Platform is accurate, complete, reliable, current, or error-free and assumes no liability in this regard.</p>
<p><strong>Limitation of Liability</strong></p>
<p>IN NO EVENT SHALL Vipin Kirana BE LIABLE FOR ANY SPECIAL, INCIDENTAL, INDIRECT OR CONSEQUENTIAL DAMAGES OF ANY KIND IN CONNECTION WITH THESE TERMS OF USE, EVEN IF USER HAS BEEN INFORMED IN ADVANCE OF THE POSSIBILITY OF SUCH DAMAGES.</p>
<p><strong>Contact Us</strong></p>
<p>Please contact us for any questions or comments (including all inquiries unrelated to copyright infringement) regarding this platform through the link: <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a>.</p>
...
<p>Vipin Kirana Internet Pvt Ltd Block B (Begonia),</p>
<p>8th Floor Embassy Tech Village,</p>
<p>Outer Ring Road, Devarabeesanahalli Village,</p>
<p>Varthur Hobli, Bengaluru East Taluk,</p>
<p>Bengaluru District, Karnataka : 560103, India</p>
<p>contact us</p>
<p>Email: grievance.officer@Vipin Kirana.com</p>
<p>Phone: 1800 202 9898</p>
<p>Time: Mon - Sat (9:00 - 18:00)</p>
<p>Customer Support: You can reach our customer support team to address any of your queries or complaints by clicking the link, selecting your order and choosing 'Need Help' option: <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a></p>
<p><strong>POLICIES</strong></p>
<p><strong>Profanity Policy</strong></p>
<p>Vipin Kirana prohibits the use of language that is racist, hateful, sexual or obscene in nature in a public area.</p>
...
<p>Vipin Kirana will consider the circumstances of an alleged policy violation and the user's trading records before taking action.</p>
...
<p>Vipin Kirana shall have the right to delete a product review posted by the customer at its sole discretion, if it is of the opinion that the review contains offensive language as stated above. Further, if Vipin Kirana is of the opinion that the review unfairly either: (i) causes disadvantage to a product; or (ii) increases the popularity of the product, Vipin Kirana shall have the right to delete the customer review. Vipin Kirana shall also, at its sole discretion have the right to blacklist the customer from posting any further customer reviews.</p>
...
<p>If Vipin Kirana has suspicion or knowledge, that any of its buyers and sellers are involved in any activity that is intended to provide claims or information that is false, misleading or not genuine, then Vipin Kirana may while reserving its rights to initiate civil and/or criminal proceedings against User may also at its sole discretion suspend, block, restrict, cancel the Display Name of such buyer and seller and /or disqualify that User and any related Users from availing protection through this program.</p>
<p>Vipin Kirana reserves its right to initiate civil and/or criminal proceedings against a User who, files a invalid and/or false claims or provides false, incomplete, or misleading information. In addition to the legal proceedings as aforesaid, Vipin Kirana may at its sole discretion suspend, block, restrict, cancel the Display Name [and its related Display Names] of such User and/or disqualify that User and any related Users from availing protection through this program. Any person who, knowingly and with intent to injure, defraud or deceive, files a Fraudulent Complaint containing false, incomplete, or misleading information may be guilty of a criminal offence and will be prosecuted to the fullest extent of the law.</p>
<p>For more details related to Replacement Policy, refer to s/help/cancellation-returns</p>
<p>Returns Policy</p>
<p>Definition: 'Return' is defined as the action of giving back the item purchased by the Buyer to the Seller on the Vipin Kirana Platform. Following situations may arise:</p>
<ol>
...
<li>On certain select days as specified by Vipin Kirana (such as 'The Big Billion Day') separate policies may be applicable.</li>
</ol>
...
<li>Incase Seller rejects the replacement request, Buyer can choose to raise a dispute by contacting us through this link: <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a>.</li>
</ol>
...
<p>Overview</p>
<p>Generally, transactions are conducted smoothly on Vipin Kirana. However there may be some cases where both the Buyers and Sellers may face issues. At Vipin Kirana, we have a Dispute Resolution process in order to resolve disputes between Buyers and Sellers.</p>
...
<p>Whenever there is a disagreement, the Buyer can contact us through this link <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a>, while the Seller can write to ss@Vipin Kirana.com, in order to raise a dispute. Disputes can be raised at a particular transaction level.</p>
...
<p>In case the Seller rejects the return request of the Buyer, and Buyer raises a dispute, then Vipin Kirana will try to mediate and resolve the dispute between both the parties. If the dispute is resolved in favour of the Buyer, a refund is provided once the product is returned to the Seller. If the dispute is settled in favour of the Seller, Buyer is entitled to any refund.</p>
<p>Buyer Protection Program</p>
<p>In case of a dispute where the Seller is unable to provide a refund or a replacement, Vipin Kirana will actively work towards reaching a resolution.</p>
...
<p>The buyer can contact us through this link <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a> if the issue with the Seller is not resolved. Vipin Kirana's Customer Support team will look into the case to check for possible fraud and if the Buyer has been blacklisted/blocked from making purchases on the Platform. Only after verifying these facts, a dispute can be registered.</p>
<p>CS team will not facilitate a conference call, CS team acts as the bridge between customer and seller. </p>
<p>When a dispute has been raised, Vipin Kirana may provide both the parties access to each others Display Names, contact details including email addresses and other details pertaining to the dispute. Buyers and Sellers are subject to final consent from Vipin Kirana for settling the dispute.</p>
<p>Buyer Eligibility and Restrictions</p>
<p>Only the Buyers who have purchased the product on Vipin Kirana are eligible for the Buyer Protection Program.</p>
...
<p>To be able to take advantage of the Buyer Protection Program, Buyers should first contact the Seller and attempt to resolve the issue. If the Buyer doesn't hear from the Seller or is unable to resolve the issue with the Seller even after contact, a dispute can be raised with Vipin Kirana by contacting us through the link: <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a></p>
...
<p>Buyers who have reached their maximum lifetime limit for claims are also not eligible. Buyers can make a maximum of 5 claims per year on Vipin Kirana. If the claim was withdrawn, it is not counted. The coverage amount will be limited to â‚¹50,000</p>
<p>Through the Buyer Protection program, Vipin Kirana does not provide any guarantee/warranty to Buyers for products sold on Vipin Kirana against technical/manufacturing defects.</p>
<p>Raising disputes against Sellers does not automatically entitle the Buyer to a refund or replacement for the product purchased. Vipin Kirana shall verify the disputes so raised and may process only such claims that are valid and genuine.</p>
<p>Vipin Kirana shall at no point be responsible for any direct or indirect losses, expenses, costs of any nature whatsoever that may be incurred by any Buyer/Seller.</p>
...
<p>Decisions made by Vipin Kirana under the Buyer Protection Program shall be final and binding on its Users.</p>
<p>Vipin Kirana reserves the right to modify / discontinue Buyer Protection Program without any prior notice period to its Users.</p>
<p>Through this program, Vipin Kirana shall not entertain claims of Buyers who have incurred loss due to delayed shipment or delivery of the item by the Seller.</p>
<p>Vipin Kirana Customer Support Team may seek additional information / clarification from Buyer to facilitate resolution of the dispute. In the event Buyer does not respond with information / clarification sought within 10 days of such request, the dispute shall be auto-closed in favour of the Seller.</p>
...
<p>Seller expressly agrees that issuing the correct and complete invoice is the sole and primary responsibility of the Seller. Furthermore, Seller shall ensure that invoices state "Powered by Vipin Kirana" and failing to do so Seller will be liable for chargebacks (as applicable).</p>
<ol>
...
<p>Private communication, including email correspondence, is not regulated by Vipin Kirana. Vipin Kirana encourages its Users to be professional, courteous and respectful when communicating by email.</p>
<p>However, Vipin Kirana will investigate and can take action on certain types of unwanted emails that violate Vipin Kirana policies.</p>
<p>Such instances:</p>
<p>Threats of Bodily Harm - Vipin Kirana does not permit Users to send explicit threats of bodily harm.</p>
<p>Misuse of Vipin Kirana System - Vipin Kirana allows Users to facilitate transactions through the Vipin Kirana system, but will investigate any misuse of this service.</p>
<p>Spoof (Fake) email - Vipin Kirana will never ask you to provide sensitive information through email. In case you receive any spoof (fake) email, you are requested to report the same to Us through 'Contact Us' tab.</p>
<p>Spam (Unsolicited Commercial email) - Vipin Kirana's spam policy applies only to unsolicited commercial messages sent by Vipin Kirana Users. Vipin Kirana Users are not allowed to send spam messages to other Users.</p>
<p>Offers to Buy or Sell Outside of Vipin Kirana - Vipin Kirana prohibits email offers to buy or sell listed products outside of the Vipin Kirana Platform. Offers of this nature are a potential fraud risk for both Buyers and Sellers.</p>
<p>Vipin Kirana policy prohibits user-to-user threats of physical harm via any method including, phone, email and on Our public message boards.</p>
<p>Violations of this policy may result in a range of actions, including:</p>
<ul>
...
<p>Vipin Kirana does not take responsibility or liability for the actions, products, content and services on the Platform, which are linked to Affiliates and / or third party Platforms using Platform's APIs or otherwise. In addition, the Platform may provide links to the third party Platforms of Our affiliated companies and certain other businesses for which, Vipin Kirana assumes no responsibility for examining or evaluating the products and services offered by them. Vipin Kirana do not warrant the offerings of, any of these businesses or individuals or the content of such third party Platform(s). Vipin Kirana does not endorse, in any way, any third party Platform(s) or content thereof.</p>
<p>Vipin Kirana Infringement Verification (FIV) - Reporting Listing Violations</p>
<p>Vipin Kirana has put in place Vipin Kirana Infringement Verification process so that intellectual property owners could easily report listings that infringe their rights. It is in Vipin Kirana's interest to ensure that infringing products are removed from the site, as they erode Buyer and good Seller trust.</p>
<ul>
<li>If you are a Verified Rights Owner and want to report a listing issue, see Vipin Kirana's FIV. Note: Only the intellectual property rights owner can report potentially infringing products or listings through FIV. If you are not the intellectual property rights owner, you can still help by getting in touch with the rights owner and encouraging them to contact us.</li>
<li>If your listing was removed through FIV, and you believe that your listing was removed in error, please contact us.</li>
</ul>
<p>Vipin Kirana does not and cannot verify that Sellers have the right or ability to sell or distribute their listed products. However, Vipin Kirana is committed to removing infringing or unlicensed products once an authorized representative of the rights owner properly reports them to Vipin Kirana.</p>
...
<p>Any person or company who holds intellectual property rights (such as a copyright, trademark or patent) which may be infringed upon by products listed on Vipin Kirana is encouraged to become a FIV member.</p>
<p>Program membership entitles you (Verified Rights Owner) to the following benefits:</p>
<ul>
<li>Rapid response by Vipin Kirana in ending listings reported by you (as the Verified Rights Owner) as allegedly infringing</li>
<li>Dedicated priority email queues for reporting alleged infringements</li>
<li>The ability to obtain identifying information about Vipin Kirana's users'</li>
</ul>
<p>How to Become a FIV Member</p>
<p>To join the FIV, we require only that you fully complete and email Us a Notice of Infringement form specifying the allegedly infringing listings and the infringed work, complete with an original authorized signature. The information requested by the Notice of Infringement is designed to ensure that parties reporting products are authorized by the rights owners, and to enable Vipin Kirana to easily identify the material or listing to be ended.</p>
<p>In the interest of keeping the process easy and simple, after we receive your first Notice of Infringement in hard copy, future notices can be sent to Us by email at ss@Vipin Kirana.com.</p>
...
<p>Vipin Kirana Internet Private Limited</p>
...
<p>A Note on Reason Codes: When identifying item numbers please use the reasons below. When removing products from the site, Vipin Kirana will inform Sellers of the specific reason for the removal of their products.</p>
...
<p>All such Notices of Infringement shall be sent to infringement@Vipin Kirana.com; or ss@Vipin Kirana.com.</p>
<p>Contacting the Seller</p>
<p>At Vipin Kirana we are committed towards ensuring that disputes between sellers and buyers are settled amicably by way of the above dispute resolution mechanisms and procedures. However, in the event that a buyer wishes to contact the seller, he/ she may proceed to do so by accessing the seller related information made available by the sellers on their product listing pages. Alternatively, the buyers may also reach out to customer support at 1800 202 9898 or access help center at <a href="https://www.Vipin Kirana.com/helpcentre">https://www.Vipin Kirana.com/helpcentre</a>.</p>
<p><strong>For Buyers from Maharashtra</strong></p>
<p><strong>Vipin Kirana Terms of Use</strong></p>
<p><strong>This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.</strong></p>
<p><strong>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name </strong>[<strong>www.Vipin Kirana.com</strong>][www.Vipin Kirana.com] <strong>(“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”) </strong></p>
<p>The Platform is owned by Vipin Kirana Internet Private Limited a company incorporated under the Companies Act, 1956 with its registered office at Buildings Alyssa, Begonia &amp; Clover, Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru – 560103, Karnataka, India and its branch offices at 2nd Floor, Block F (Flora), Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru-560103, Karnataka, India and; 447/C, 12th Main, 4th Block, Koramangala, Bengaluru-560034, Karnataka, India (hereinafter referred to as "Vipin Kirana").</p>
...
<p><strong>Digital Content: Vipin Kirana Video</strong></p>
<ol>
<li><p>These Terms of Service (“Terms”) govern your access to and use of Vipin Kirana Video (hereinafter referred to as “Content”). By viewing the Contents you agree to be bound by these Terms. Content posted on the Platform is public and can be viewed by everyone who can see the Page.</p>
</li>
<li><p>The Content is being hosted on Vipin Kirana mobile App only (“Platform”), that is owned and operated by Vipin Kirana Internet Private Limited (“Vipin Kirana”, “We” or “Our”).</p>
</li>
<li><p>Use of Vipin Kirana Services is available only to persons who can form a legally binding contract under the Indian Contract Act, 1872.You must be 18 years of age, to avail the Services. Minors may only use the service under the supervision of an adult. </p>
</li>
<li><p>Vipin Kirana is hosting the Content generated by third parties (“Platform Partners/Content Owners”) as well as Vipin Kirana (“Vipin Kirana Original”) (collectively referred as “Content”) , within the FK Platform for convenience of Platform Users free of cost that will allow you to access the digital Content.. As such, Vipin Kirana has no ownership or control whatsoever in the Contents displayed which are third party generated. The Contents posted (other than Vipin Kirana Originals) are third party generated contents wherein Vipin Kirana plays no role in creating/developing the Content. You are responsible for your use of the Platform for viewing the Content. </p>
</li>
<li><p>By hosting the Content on the Platform, Vipin Kirana is neither guaranteeing nor giving any warranty nor making any representation with respect to the Contents. Vipin Kirana is neither endorsing the views, products or the Services, nor is it responsible for quality or features of the content displayed on the Platform.</p>
</li>
<li><p>Any information on the Platform, whether the content or any other information (other than Vipin Kirana Original), have not been verified by Vipin Kirana, therefore, Vipin Kirana shall not be responsible for any such content or information. Vipin Kirana will not bear any obligation or liability if You rely on the Contents.</p>
</li>
<li><p>If You choose to view or rely, Vipin Kirana will neither be a party to nor in any manner concerned with the same nor be liable or responsible for any act or omission of the Content Owner.</p>
</li>
...
<li><p>You further acknowledge that all the intellectual property rights contained in Vipin Kirana Original contents are solely owned by Vipin Kirana. During your Vipin Kirana membership we grant you a limited, non-exclusive, non-transferable, revocable right to access the Vipin Kirana Video service and view the Content. Except for the foregoing, no right, title or interest shall be transferred to you.</p>
</li>
<li><p>We can terminate your account or place your account on hold in order to protect our/Partners interest from an actual, probable or suspected theft or other fraudulent activity.</p>
</li>
<li><p>Any use or reliance on any Content or materials obtained by you through the Content is at your own risk. We do not endorse, support, represent or guarantee the completeness, truthfulness, accuracy, or reliability of any Content or communications posted on the Platform or endorse any opinions expressed via the contents. You understand that by using the Platform, you may be exposed to Content that might be offensive, harmful, inaccurate or otherwise inappropriate, or in some cases, postings that have been mislabeled or are otherwise deceptive. All Content is the sole responsibility of the Content Owners who originated such Content. Vipin Kirana may not monitor or control the Content posted on the Platform and, we do not take responsibility for such Content.</p>
</li>
<li><p>We reserve the right to remove Content that violates the Terms of Use, including for example, copyright or trademark violations, impersonation, unlawful conduct, or harassment.</p>
</li>
<li><p>We may use information such as device ID, location or an account email address used with an existing Vipin Kirana account to determine eligibility and any offers therof.</p>
</li>
...
<li><p>By using the Services you agree that Vipin Kirana, its parents, affiliates, related companies, officers, directors, employees, agents representatives, partners and licensors, liability is limited to the maximum extent permissible by Law.</p>
</li>
<li><p>You shall indemnify and hold harmless Vipin Kirana its owner, licensee, affiliates, subsidiaries, group companies, partners (as applicable) and their respective officers, directors, agents, and employees from any claim, demand, or actions including reasonable attorneys' fees made by any third party or penalty imposed due to or arising out of your breach of the ToU, privacy policy and other policies or your violation of any law, rules, regulations or the rights (including infringement of intellectual property rights) of a third party.</p>
</li>
<li><p>Governing laws: The ToU shall be governed, interpreted, and construed in accordance with the laws of India. The place of jurisdiction shall exclusively be Bangalore.</p>
</li>
<li><p>We may revise these Terms from time to time.</p>
</li>
</ol>
<p><strong>Indemnity</strong></p>
<p>You shall indemnify and hold harmless Vipin Kirana, its owner, licensee, affiliates, subsidiaries, group companies (as applicable) and their respective officers, directors, agents, and employees, from any claim or demand, or actions including reasonable attorneys' fees, made by any third party or penalty imposed due to or arising out of Your breach of this Terms of Use, privacy Policy and other Policies, or Your violation of any law, rules or regulations or the rights (including infringement of intellectual property rights) of a third party.</p>
...
<p>All such Notices of Infringement shall be sent to infringement@Vipin Kirana.com; or ss@Vipin Kirana.com.</p>
<p>Contacting the Seller</p>
<p>At Vipin Kirana we are committed towards ensuring that disputes between sellers and buyers are settled amicably by way of the above dispute resolution mechanisms and procedures. However, in the event that a buyer wishes to contact the seller, he/ she may proceed to do so by accessing the seller related information made available by the sellers on their product listing pages. Alternatively, the buyers may also reach out to customer support at 1800 202 9898 or access help center at <a href="http://www.Vipin Kirana.com/helpcentre">http://www.Vipin Kirana.com/helpcentre</a></p>
</div>
      </Grid>
    </Grid>
    </div>
